...
To keep all the code in a single repository for the simplicity of this demonstration, the analytics code described below is located in the `R/` directory of this repository. In general, it is best to follow best practices to keep this code in a separate repository or branch as specified above. 
